...
export const HeroSection = () => {
  ...
  const stats = [
    { icon: Trophy, value: "5+", label: t('hero.statChampionships') },
    { icon: Users, value: "30+", label: t('hero.statPlayers') },
    { icon: Target, value: "2", label: t('hero.statGames') },
  ];
    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1
            className="font-display text-5xl md:text-7xl lg:text-8xl font-black leading-tight mb-6 animate-slide-up"
          ...
          <p
            className="font-body text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10 animate-slide-up"
          ...
          {/* Stats */}
          <div
            className="grid grid-cols-3 gap-8 max-w-lg animate-slide-up"
