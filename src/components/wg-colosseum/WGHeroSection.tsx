...
export const WGHeroSection = () => {
  ...
  const stats = [
    { icon: Users, value: "8", label: t('wgColosseum.statTeams') },
    { icon: Trophy, value: "€500", label: t('wgColosseum.statPrizePool') },
    { icon: Calendar, value: "10", label: t('wgColosseum.statWeeks') },
    { icon: Tv, value: "50+", label: t('wgColosseum.statPlayers') },
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-600/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <span className="inline-block px-4 py-2 bg-violet-500/20 border border-violet-500/30 rounded-full text-violet-400 text-sm font-semibold mb-8 animate-slide-up">
            {t('wgColosseum.season')}
          </span>

          <h1
            className="text-5xl md:text-7xl lg:text-8xl font-display font-bold text-white mb-6 animate-slide-up"
          ...
          <p
            className="text-xl md:text-2xl text-gray-400 mb-10 max-w-2xl mx-auto animate-slide-up"
            style={{ animationDelay: "0.2s" }}
          >
            {t('wgColosseum.heroDescription')}
          </p>
