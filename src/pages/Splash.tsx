...
const Splash = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center overflow-hidden relative">
      ...
      <div
        className="absolute top-1/2 right-1/4 w-96 h-96 bg-violet-500/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">{t('splash.subtitle')}</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-20 h-20 bg-primary/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary/30 transition-colors">
                <img src="waylogo.png" alt="Way Gaming Logo" className="w-12 h-12 object-contain" />
              </div>
              <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
                WAY <span className="text-primary">GAMING ORG</span>
              </h2>
              <p className="text-gray-400 mb-6">{t('splash.orgDesc')}</p>
          ...
          {/* WG Colosseum (Coming Soon) */}
          <div className="group relative overflow-hidden rounded-2xl border border-violet-500/20 bg-gradient-to-br from-black to-violet-900/10 p-8 md:p-12 cursor-not-allowed opacity-70">
            {/* Coming Soon Overlay */}
            <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] z-20 flex items-center justify-center">
              <div className="text-center">
                <div className="inline-block px-6 py-3 bg-violet-500/20 border border-violet-500/40 rounded-full">
                  <span className="text-xl md:text-2xl font-display font-bold text-violet-400">
                    {t('splash.comingSoon')}
                  </span>
                </div>
              </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-6">{t('splash.colosseumDesc')}</p>
              <div className="flex items-center gap-2 text-violet-400/50 font-semibold">
                <span>{t('splash.enterArena')}</span>
