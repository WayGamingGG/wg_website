...
const socialLinks = [
  {
    name: "Discord",
    descriptionKey: "contact.discordDescription",
...
const Contact = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Contactos — WayGaming Esports</title>
        <meta name="description" content="Entra em contacto com a WayGaming. Encontra-nos nas redes sociais ou envia-nos um email." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content={SEO_SITE_NAME} />
        <meta property="og:title" content="Contactos — WayGaming Esports" />
        <meta property="og:description" content="Entra em contacto com a WayGaming. Encontra-nos nas redes sociais ou envia-nos um email." />
        <meta property="og:image" content={SEO_LOGO} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content={SEO_TWITTER} />
        <meta name="twitter:title" content="Contactos — WayGaming Esports" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold mb-6">
              ...
              <span className="text-primary text-glow">{t('contact.title').split(' ').slice(-1)}</span>
            </h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-display font-bold text-center mb-12">
            {t('contact.socialTitle').split(' ').slice(0, -2).join(' ')}{' '}
            <span className="text-primary">{t('contact.socialTitle').split(' ').slice(-2).join(' ')}</span>
          </h2>
                  ...
                  <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {social.descriptionKey ? t(social.descriptionKey) : social.description}
                      </p>
                    </div>
          ...
          <div className="grid md:grid-cols-1 gap-8 max-w-2xl mx-auto">
            <Card className="bg-card border-border">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-display font-bold mb-2">{t('contact.emailTitle')}</h3>
